  ...
  return (
    <div className="field">
      ...
      <p className="field-help">
        Optional. Get occasional event announcements and important Guiding Light
        updates. You can change this preference later from your profile.
      </p>
      <label className="checkbox-pill" htmlFor="newsletterSubscribed">
        ...
        <span className="checkbox-pill__content">
          ...
          <span>
            Email me about new events, community updates, and major site
            changes.
          </span>
        </span>
      </label>
